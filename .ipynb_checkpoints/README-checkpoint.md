...
Energy spectra over the course of the simulated data for a 100 second pre-storage run carried out in the 85 mm normalization configuration. Energy spectrum is set within PENTrack to be x^2. See `sims.ipynb` for more description.

### merged_E_spec_sqrt

Energy spectra over the course of the simulated data for a 100 second pre-storage run carried out in the 85 mm normalization configuration. Energy spectrum is set within PENTrack to be sqrt{x}. See `sims.ipynb` for more description.
